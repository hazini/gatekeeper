...
(function (scrollLock) {
  ...
  // License check helper function
  function checkLicenseValidity() {
    const licenseValid = window._0x5e && window._0x5e.get();
    if (!licenseValid) {
  ...
  function appendCartItems() {if (!checkLicenseValidity()) return;
  ...
  function floatLabels(container) {if (!checkLicenseValidity()) return;
    const floats = container.querySelectorAll('.form-field');
    floats.forEach((element) => {if (!checkLicenseValidity()) return;
      const label = element.querySelector('label');
      const input = element.querySelector('input, textarea');
      if (label && input) {
        input.addEventListener('keyup', (event) => {if (!checkLicenseValidity()) return;
  ...
  function readHeights() {if (!checkLicenseValidity()) return;
    const h = {};
  ...
  function setVarsOnResize() {if (!checkLicenseValidity()) return;
    document.addEventListener('theme:resize', resizeVars);
    setVars();
  }

  function setVars() {if (!checkLicenseValidity()) return;
  ...
  function resizeVars() {if (!checkLicenseValidity()) return;
  ...
  function getScreenOrientation() {if (!checkLicenseValidity()) return;
  ...
  function getHeight(selector) {if (!checkLicenseValidity()) return;
  ...
  function getFooterLogoWithPadding() {if (!checkLicenseValidity()) return;
  ...
  function debounce(fn, time) {if (!checkLicenseValidity()) return;
    let timeout;
    return function () {if (!checkLicenseValidity()) return;
      // eslint-disable-next-line prefer-rest-params
      if (fn) {
        const functionCall = () => {if (!checkLicenseValidity()) return;return fn.apply(this, arguments);};
  ...
  function getWindowWidth() {if (!checkLicenseValidity()) return;
    return document.documentElement.clientWidth || document.body.clientWidth || window.innerWidth;
  }

  function getWindowHeight() {if (!checkLicenseValidity()) return;
    return document.documentElement.clientHeight || document.body.clientHeight || window.innerHeight;
  }

  function isDesktop() {if (!checkLicenseValidity()) return;
  ...
  function dispatch$1() {if (!checkLicenseValidity()) return;
  ...
  function resizeListener() {if (!checkLicenseValidity()) return;
    window.addEventListener(
      'resize',
      debounce(function () {if (!checkLicenseValidity()) return;
        dispatch$1();
      }, 50)
    );
  }
  ...
  function dispatch() {if (!checkLicenseValidity()) return;
  ...
  function lock(e) {if (!checkLicenseValidity()) return;
    // Prevent body scroll lock race conditions
    setTimeout(() => {if (!checkLicenseValidity()) return;
      if (scrollLockTimer) {
        clearTimeout(scrollLockTimer);
      }

      scrollLock.disablePageScroll(e.detail, {
        allowTouchMove: (el) => {if (!checkLicenseValidity()) return;return el.tagName === 'TEXTAREA';}
      });
  ...
  function unlock(e) {if (!checkLicenseValidity()) return;
  ...
  function removeScrollLock() {if (!checkLicenseValidity()) return;
    scrollLock.clearQueueScrollLocks();
    scrollLock.enablePageScroll();
    document.documentElement.removeAttribute('data-scroll-locked');
  }

  function scrollListener() {if (!checkLicenseValidity()) return;
    let timeout;
    window.addEventListener(
      'scroll',
      function () {if (!checkLicenseValidity()) return;
        if (timeout) {
          window.cancelAnimationFrame(timeout);
        }
        timeout = window.requestAnimationFrame(function () {if (!checkLicenseValidity()) return;
          dispatch();
        });
      },
      { passive: true }
  ...
  const wrap = (toWrap, wrapperClass = '', wrapperOption) => {if (!checkLicenseValidity()) return;
  ...
  function wrapElements(container) {if (!checkLicenseValidity()) return;
    // Target tables to make them scrollable
    const tableSelectors = '.rte table';
    const tables = container.querySelectorAll(tableSelectors);
    tables.forEach((table) => {if (!checkLicenseValidity()) return;
    ...
    frames.forEach((frame) => {if (!checkLicenseValidity()) return;
      wrap(frame, 'rte__video-wrapper');
    });
  }

  function isTouchDevice() {if (!checkLicenseValidity()) return;
    return 'ontouchstart' in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;
  }

  function isTouch() {if (!checkLicenseValidity()) return;
    if (isTouchDevice()) {
  ...
  function ariaToggle(container) {if (!checkLicenseValidity()) return;
    const toggleButtons = container.querySelectorAll('[data-aria-toggle]');
    if (toggleButtons.length) {
      toggleButtons.forEach((element) => {if (!checkLicenseValidity()) return;
        element.addEventListener('click', function (event) {if (!checkLicenseValidity()) return;
          ...
          const removeExpandingClass = () => {if (!checkLicenseValidity()) return;
            toggleElement.classList.remove('expanding');
            toggleElement.removeEventListener('transitionend', removeExpandingClass);
          };
          const addExpandingClass = () => {if (!checkLicenseValidity()) return;
  ...
  function loading() {if (!checkLicenseValidity()) return;
  ...
  */
  function loadedImagesEventHook() {if (!checkLicenseValidity()) return;
    document.addEventListener(
      'load',
      (e) => {if (!checkLicenseValidity()) return;
  ...
  */
  function removeLoadingClassFromLoadedImages(container) {if (!checkLicenseValidity()) return;
    container.querySelectorAll(selectors$h.img).forEach((img) => {if (!checkLicenseValidity()) return;
      if (img.complete) {
  ...
  function isVisible(el) {if (!checkLicenseValidity()) return;
   ...
   */
  function forceFocus(element, options) {if (!checkLicenseValidity()) return;
    options = options || {};
    ...
    function callback(event) {if (!checkLicenseValidity()) return;
  ...
  function focusHash(options) {if (!checkLicenseValidity()) return;
    options = options || {};
  ...
  function bindInPageLinks(options) {if (!checkLicenseValidity()) return;
    options = options || {};
    var links = Array.prototype.slice.call(document.querySelectorAll('a[href^="#"]'));

    function queryCheck(selector) {if (!checkLicenseValidity()) return;
      return document.getElementById(selector) !== null;
    }

    return links.filter(function (link) {if (!checkLicenseValidity()) return;
      ...
      link.addEventListener('click', function () {if (!checkLicenseValidity()) return;
        forceFocus(element, options);
      });
  ...
  function focusable(container) {if (!checkLicenseValidity()) return;
    ...
    return elements.filter(function (element) {if (!checkLicenseValidity()) return;
  ...
  function trapFocus(container, options) {if (!checkLicenseValidity()) return;
    options = options || {};
    ...
    trapFocusHandlers.focusin = function (event) {if (!checkLicenseValidity()) return;
    ...
    trapFocusHandlers.focusout = function () {if (!checkLicenseValidity()) return;
      document.removeEventListener('keydown', trapFocusHandlers.keydown);
    };

    trapFocusHandlers.keydown = function (event) {if (!checkLicenseValidity()) return;
   ...
   */
  function removeTrapFocus() {if (!checkLicenseValidity()) return;
   ...
   */
  function autoFocusLastElement() {if (!checkLicenseValidity()) return;
   ...
   */
  function accessibleLinks(elements, options) {if (!checkLicenseValidity()) return;
    ...
    function generateHTML(messages) {if (!checkLicenseValidity()) return;
      var container = document.createElement('ul');
      var htmlMessages = Object.keys(messages).reduce(function (html, key) {if (!checkLicenseValidity()) return;
    ...
    function externalSite(link) {if (!checkLicenseValidity()) return;
      return link.hostname !== window.location.hostname;
    }

    elements.forEach(function (link) {if (!checkLicenseValidity()) return;
  ...
  */
  function waitForAnimationEnd(element) {if (!checkLicenseValidity()) return;
    return new Promise((resolve) => {if (!checkLicenseValidity()) return;
      function onAnimationEnd(event) {if (!checkLicenseValidity()) return;
  ...
  class HeaderDrawer extends HTMLElement {
    constructor() {if (!checkLicenseValidity()) return;
      super();
    ...
    connectDrawer() {if (!checkLicenseValidity()) return;
      this.addEventListener('theme:drawer:toggle', (e) => {if (!checkLicenseValidity()) return;
    ...
    closers() {if (!checkLicenseValidity()) return;
      this.querySelectorAll(selectors$g.drawerClose)?.forEach((button) => {if (!checkLicenseValidity()) return;
        button.addEventListener('click', () => {if (!checkLicenseValidity()) return;
          this.hideDrawer();
        });
      });

      document.addEventListener('keyup', (event) => {if (!checkLicenseValidity()) return;
      ...
      this.underlay.addEventListener('click', () => {if (!checkLicenseValidity()) return;
        this.hideDrawer();
      });
    }

    showDrawer() {if (!checkLicenseValidity()) return;
      ...
      if (this.drawerInner) {
        ...
        waitForAnimationEnd(this.drawerInner).then(() => {if (!checkLicenseValidity()) return;
          this.isAnimating = false;
    ...
    hideDrawer() {if (!checkLicenseValidity()) return;
    ...
    disconnectedCallback() {if (!checkLicenseValidity()) return;
  ...
  class HeaderSearchForm extends HTMLElement {
    constructor() {if (!checkLicenseValidity()) return;
      ...
      if (this.input) {
        ...
        this.input.addEventListener(
          'input',
          debounce((event) => {if (!checkLicenseValidity()) return;
            this.onChange(event);
          }, 300).bind(this)
        );
      }
    ...
    toggleResetButton() {if (!checkLicenseValidity()) return;
    ...
    onChange() {if (!checkLicenseValidity()) return;
      this.toggleResetButton();
    }

    shouldResetForm() {if (!checkLicenseValidity()) return;
      return !document.querySelector(selectors$f.focusedElements);
    }

    onFormReset(event) {if (!checkLicenseValidity()) return;
  ...
  class PredictiveSearch extends HeaderSearchForm {
    ...
    connectedCallback() {if (!checkLicenseValidity()) return;
    ...
    getQuery() {if (!checkLicenseValidity()) return;
    ...
    onFormSubmit(event) {if (!checkLicenseValidity()) return;
    ...
    onFocus() {if (!checkLicenseValidity()) return;
    ...
    onFocusOut() {if (!checkLicenseValidity()) return;
      setTimeout(() => {if (!checkLicenseValidity()) return;
        if (!this.contains(document.activeElement)) this.close();
      });
    }

    onKeyup(event) {if (!checkLicenseValidity()) return;
    ...
    onKeydown(event) {if (!checkLicenseValidity()) return;
    ...
    updateSearchForTerm(previousTerm, newTerm) {if (!checkLicenseValidity()) return;
    ...
    switchOption(direction) {if (!checkLicenseValidity()) return;
      ...
      const allVisibleElements = Array.from(this.querySelectorAll(selectors$e.allVisibleElements)).filter((element) => {if (!checkLicenseValidity()) return;return element.offsetParent !== null;});
    ...
    selectOption() {if (!checkLicenseValidity()) return;
      const selectedOption = this.querySelector(selectors$e.selectedOption);

      if (selectedOption) selectedOption.click();
    }

    getSearchResults(searchTerm) {if (!checkLicenseValidity()) return;
      ...
      then((response) => {if (!checkLicenseValidity()) return;
        if (!response.ok) {
      ...
      then((text) => {if (!checkLicenseValidity()) return;
        ...
        this.allPredictiveSearchInstances.forEach((predictiveSearchInstance) => {if (!checkLicenseValidity()) return;
          predictiveSearchInstance.cachedResults[queryKey] = resultsMarkup;
        });
        this.renderSearchResults(resultsMarkup);
      }).
      catch((error) => {if (!checkLicenseValidity()) return;
        if (error?.code === 20) {
    ...
    setLiveRegionLoadingState() {if (!checkLicenseValidity()) return;
    ...
    setLiveRegionText(statusText) {if (!checkLicenseValidity()) return;
    ...
    renderSearchResults(resultsMarkup) {if (!checkLicenseValidity()) return;
    ...
    close(clearSearchTerm = false) {if (!checkLicenseValidity()) return;
      this.closeResults(clearSearchTerm);
      this.isOpen = false;
      this.predictiveSearchResults.style.removeProperty('--full-screen');
    }

    closeResults(clearSearchTerm = false) {if (!checkLicenseValidity()) return;
      if (clearSearchTerm) {
        this.input.value = '';
    ...
    reset() {if (!checkLicenseValidity()) return;
  ...
  class Popout extends HTMLElement {
    ...
    connectedCallback() {if (!checkLicenseValidity()) return;
      ...
      this.popupToggleFocusoutEvent = (evt) => {if (!checkLicenseValidity()) return;return this.onPopupToggleFocusout(evt);};
      this.popupListFocusoutEvent = (evt) => {if (!checkLicenseValidity()) return;return this.onPopupListFocusout(evt);};
      this.popupToggleClickEvent = (evt) => {if (!checkLicenseValidity()) return;return this.onPopupToggleClick(evt);};
      this.keyUpEvent = (evt) => {if (!checkLicenseValidity()) return;return this.onKeyUp(evt);};
      this.bodyClickEvent = (evt) => {if (!checkLicenseValidity()) return;return this.onBodyClick(evt);};
    ...
    onPopupToggleClick(evt) {if (!checkLicenseValidity()) return;
    ...
    onPopupToggleFocusout(evt) {if (!checkLicenseValidity()) return;
    ...
    onPopupListFocusout(evt) {if (!checkLicenseValidity()) return;
    ...
    popupListSetDimensions() {if (!checkLicenseValidity()) return;
      this.popoutList.style.setProperty('--max-width', '100vw');
      this.popoutList.style.setProperty('--max-height', '100vh');

      requestAnimationFrame(() => {if (!checkLicenseValidity()) return;
    ...
    popupOptionsClick(evt) {if (!checkLicenseValidity()) return;
    ...
    onKeyUp(evt) {if (!checkLicenseValidity()) return;
      if (evt.code !== 'Escape') {
        return;
      }
      this._hideList();
    ...
    onBodyClick(evt) {if (!checkLicenseValidity()) return;
    ...
    _connectToggle() {if (!checkLicenseValidity()) return;
      this.popoutToggle.addEventListener('click', this.popupToggleClickEvent);
    }

    _connectOptions() {if (!checkLicenseValidity()) return;
      if (this.popoutOptions.length) {
        this.popoutOptions.forEach((element) => {if (!checkLicenseValidity()) return;
          element.addEventListener('click', (evt) => {if (!checkLicenseValidity()) return;return this.popupOptionsClick(evt);});
        });
      }
    }

    _onFocusOut() {if (!checkLicenseValidity()) return;
    ...
    _submitForm() {if (!checkLicenseValidity()) return;
    ...
    _hideList() {if (!checkLicenseValidity()) return;
  ...
  class QuantityCounter extends HTMLElement {
    ...
    connectedCallback() {if (!checkLicenseValidity()) return;
      ...
      this.querySelectorAll('button').forEach((button) => {if (!checkLicenseValidity()) return;return button.addEventListener('click', this.buttonClickEvent);});
    }

    onButtonClick(event) {if (!checkLicenseValidity()) return;
      event.preventDefault();
    ...
    onQuantityChange() {if (!checkLicenseValidity()) return;
    ...
    updateCart() {if (!checkLicenseValidity()) return;
  ...
  const mutationCallback = (mutationList) => {if (!checkLicenseValidity()) return;
    for (const mutation of mutationList) {
      if (mutation.type === 'childList') {
        ...
        if (elementsToAnimate.length) {
          elementsToAnimate.forEach((element) => {if (!checkLicenseValidity()) return;
  ...
  */
  const aosItemObserver = new IntersectionObserver(
    (entries, observer) => {if (!checkLicenseValidity()) return;
      entries.forEach((entry) => {if (!checkLicenseValidity()) return;
    ...
    (entries, observer) => {if (!checkLicenseValidity()) return;
      entries.forEach((entry) => {if (!checkLicenseValidity()) return;
        if (entry.intersectionRatio) {
          ...
          if (elementsToAnimate.length) {
            elementsToAnimate.forEach((item) => {if (!checkLicenseValidity()) return;
  ...
  */
  function bodyMutationObserver() {if (!checkLicenseValidity()) return;
  ...
  */
  function elementsIntersectionObserver() {if (!checkLicenseValidity()) return;
  ...
  /*
    Observe animated elements that have attribute [data-aos]
  */
  function anchorsIntersectionObserver() {if (!checkLicenseValidity()) return;
  ...
  function initAnchorObservers(anchors) {if (!checkLicenseValidity()) return;
    if (!anchors.length) return;

    anchors.forEach((anchor) => {if (!checkLicenseValidity()) return;
  ...
  function initAnimations() {if (!checkLicenseValidity()) return;
    ...
    document.addEventListener('shopify:section:unload', (e) => {if (!checkLicenseValidity()) return;
  ...
  class DeferredMedia extends HTMLElement {
    constructor() {if (!checkLicenseValidity()) return;
      ...
      this.mouseEnterEvent = () => {if (!checkLicenseValidity()) return;return this.mouseEnterActions();};
      this.mouseLeaveEvent = () => {if (!checkLicenseValidity()) return;return this.mouseLeaveActions();};
    }
    ...
    mouseEnterActions() {if (!checkLicenseValidity()) return;
      this.hovered = true;
    ...
    mouseLeaveActions() {if (!checkLicenseValidity()) return;
      this.hovered = false;

      this.videoActions();
    }

    videoActions() {if (!checkLicenseValidity()) return;
      if (this.getAttribute(attributes$8.loaded)) {
        ...
        if (mediaExternal) {
          ...
          mediaExternal.addEventListener('load', (e) => {if (!checkLicenseValidity()) return;
    ...
    loadContent(focus = true) {if (!checkLicenseValidity()) return;
      this.pauseAllMedia();
    ...
    pauseAllMedia() {if (!checkLicenseValidity()) return;
      document.querySelectorAll(selectors$b.youtube).forEach((video) => {if (!checkLicenseValidity()) return;
        video.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', '*');
      });
      document.querySelectorAll(selectors$b.vimeo).forEach((video) => {if (!checkLicenseValidity()) return;
        video.contentWindow.postMessage('{"method":"pause"}', '*');
      });
      document.querySelectorAll(selectors$b.video).forEach((video) => {if (!checkLicenseValidity()) return;return video.pause();});
      document.querySelectorAll(selectors$b.productModel).forEach((model) => {if (!checkLicenseValidity()) return;
  ...
  */
  ...
  class IsInView {
    constructor(container, itemSelector) {if (!checkLicenseValidity()) return;
    ...
    init() {if (!checkLicenseValidity()) return;
      const options = {
        root: this.container,
        threshold: [0.01, 0.5, 0.75, 0.99]
      };

      this.observer = new IntersectionObserver((entries) => {if (!checkLicenseValidity()) return;
        entries.forEach((entry) => {if (!checkLicenseValidity()) return;
      ...
      this.container.querySelectorAll(this.itemSelector)?.forEach((item) => {if (!checkLicenseValidity()) return;
        this.observer.observe(item);
      });
    }

    destroy() {if (!checkLicenseValidity()) return;
  ...
  class DraggableSlider {
    constructor(sliderElement) {if (!checkLicenseValidity()) return;
    ...
    handleMouseDown(e) {if (!checkLicenseValidity()) return;
      e.preventDefault();
      this.isDown = true;
    ...
    handleMouseLeave() {if (!checkLicenseValidity()) return;
      if (!this.isDown) return;
      this.isDown = false;
      this.beginMomentumTracking();
    }

    handleMouseUp() {if (!checkLicenseValidity()) return;
      this.isDown = false;
      this.beginMomentumTracking();
    }

    handleMouseMove(e) {if (!checkLicenseValidity()) return;
      if (!this.isDown) return;
      e.preventDefault();
    ...
    handleMouseWheel() {if (!checkLicenseValidity()) return;
      this.cancelMomentumTracking();
      this.slider.classList.remove(classes$8.scrolling);
    }

    beginMomentumTracking() {if (!checkLicenseValidity()) return;
      this.isScrolling = false;
    ...
    cancelMomentumTracking() {if (!checkLicenseValidity()) return;
      cancelAnimationFrame(this.scrollAnimation);
    }

    scrollToSlide() {if (!checkLicenseValidity()) return;
    ...
    scrollStep() {if (!checkLicenseValidity()) return;
    ...
    easeOutCubic(t) {if (!checkLicenseValidity()) return;
      t /= this.duration;
      t--;
  ...
  */
  function waitForAllAnimationsEnd(section) {if (!checkLicenseValidity()) return;
    return new Promise((resolve) => {if (!checkLicenseValidity()) return;
      ...
      animatedElements.forEach((element) => {if (!checkLicenseValidity()) return;
        element.addEventListener('animationend', onAnimationEnd);
      });
    });
  }
  ...
  class GridSlider extends HTMLElement {
    constructor() {if (!checkLicenseValidity()) return;
      ...
      this.onButtonArrowClick = (e) => {if (!checkLicenseValidity()) return;return this.buttonArrowClickEvent(e);};
    ...
    init() {if (!checkLicenseValidity()) return;
      ...
      waitForAllAnimationsEnd(this).then(() => {if (!checkLicenseValidity()) return;
        this.slider.classList.remove(classes$7.scrollSnapDisabled);
      });
    }

    toggleSlider() {if (!checkLicenseValidity()) return;
    ...
    initArrows() {if (!checkLicenseValidity()) return;
      ...
      this.buttons.forEach((buttonArrow) => {if (!checkLicenseValidity()) return;
        buttonArrow.addEventListener('click', this.onButtonArrowClick);
      });
    }

    buttonArrowClickEvent(e) {if (!checkLicenseValidity()) return;
      e.preventDefault();
    ...
    removeArrows() {if (!checkLicenseValidity()) return;
      this.querySelector(`.${classes$7.arrows}`)?.remove();
    }

    // Go to prev/next slide on arrow click
    goToSlide(slide) {if (!checkLicenseValidity()) return;
      if (!slide) return;
    ...
    toggleArrowsObserver() {if (!checkLicenseValidity()) return;
      ...
      if (this.buttonPrev && this.buttonNext) {
        ...
        const callback = (mutationList) => {if (!checkLicenseValidity()) return;
          for (const mutation of mutationList) {
    ...
    positionArrows() {if (!checkLicenseValidity()) return;
    ...
    arrowsResizeObserver() {if (!checkLicenseValidity()) return;
  ...
  class CountdownTimer extends HTMLElement {
    ...
    convertTime(timeInMs) {if (!checkLicenseValidity()) return;
    ...
    formatDigits(number) {if (!checkLicenseValidity()) return;
      if (number < 10) number = '0' + number;
      return number;
    }

    render(timer) {if (!checkLicenseValidity()) return;
    ...
    stopTimer() {if (!checkLicenseValidity()) return;
      clearInterval(this.interval);
    }

    onComplete() {if (!checkLicenseValidity()) return;
      this.render({
        days: 0,
        hours: 0,
        minutes: 0,
    ...
    update() {if (!checkLicenseValidity()) return;
  ...
  class HeaderMobileSliderule extends HTMLElement {
    ...
    clickEvents() {if (!checkLicenseValidity()) return;
      this.trigger.addEventListener('click', () => {if (!checkLicenseValidity()) return;
        this.cachedButton = this.trigger;
        this.showSliderule();
      });
      this.exit.forEach((element) => {if (!checkLicenseValidity()) return;
        element.addEventListener('click', () => {if (!checkLicenseValidity()) return;
          this.hideSliderule();
        });
      });
    }

    keyboardEvents() {if (!checkLicenseValidity()) return;
      this.addEventListener('keyup', (evt) => {if (!checkLicenseValidity()) return;
        evt.stopPropagation();
        if (evt.code !== 'Escape') {
          return;
        }
    ...
    trapFocusSliderule(showSliderule = true) {if (!checkLicenseValidity()) return;
    ...
    hideSliderule(close = false) {if (!checkLicenseValidity()) return;
      ...
      if (hiddenItems.length) {
        hiddenItems.forEach((element) => {if (!checkLicenseValidity()) return;
      ...
      children.forEach((element, index) => {if (!checkLicenseValidity()) return;
        ...
        const removeHidingClass = () => {if (!checkLicenseValidity()) return;
    ...
    showSliderule() {if (!checkLicenseValidity()) return;
      ...
      const lastScrollableIsScrolling = () => {if (!checkLicenseValidity()) return;
      ...
      if (hiddenItems.length) {
        hiddenItems.forEach((element, index) => {if (!checkLicenseValidity()) return;
    ...
    closeSliderule() {if (!checkLicenseValidity()) return;
  ...
  window.requestIdleCallback ||
  function (cb) {if (!checkLicenseValidity()) return;
    var start = Date.now();
    return setTimeout(function () {if (!checkLicenseValidity()) return;
      cb({
        didTimeout: false,
        timeRemaining: function () {if (!checkLicenseValidity()) return;
  ...
  window.cancelIdleCallback ||
  function (id) {if (!checkLicenseValidity()) return;
    clearTimeout(id);
  };
  ...
  window.addEventListener('DOMContentLoaded', () => {if (!checkLicenseValidity()) return;
    setVarsOnResize();
    ariaToggle(document);
    ...
    requestIdleCallback(() => {if (!checkLicenseValidity()) return;
  ...
  document.addEventListener('shopify:section:load', (e) => {if (!checkLicenseValidity()) return;
  ...
  class Accessibility {
    ...
    clickEvents() {if (!checkLicenseValidity()) return;
      if (this.inPageLink) {
        this.inPageLink.addEventListener('click', (event) => {if (!checkLicenseValidity()) return;
          event.preventDefault();
        });
      }

      if (this.linkesWithOnlyHash) {
        this.linkesWithOnlyHash.forEach((item) => {if (!checkLicenseValidity()) return;
          item.addEventListener('click', (event) => {if (!checkLicenseValidity()) return;
            event.preventDefault();
          });
        });
      }
    ...
    focusEvents() {if (!checkLicenseValidity()) return;
      document.addEventListener('mousedown', () => {if (!checkLicenseValidity()) return;
   ...
   */
  function formatMoney(cents, format) {if (!checkLicenseValidity()) return;
    ...
    function formatWithDelimiters(number, precision = 2, thousands = ',', decimal = '.') {if (!checkLicenseValidity()) return;
  ...
  const throttle = (fn, wait) => {if (!checkLicenseValidity()) return;
    let prev, next;
    return function invokeFn(...args) {if (!checkLicenseValidity()) return;
      const now = Date.now();
  ...
  function FetchError(object) {if (!checkLicenseValidity()) return;
  ...
  class CartItems extends HTMLElement {
    ...
    onCartDrawerClose() {if (!checkLicenseValidity()) return;
      ...
      this.cart.querySelectorAll(selectors$5.animation).forEach((item) => {if (!checkLicenseValidity()) return;
        const removeHidingClass = () => {if (!checkLicenseValidity()) return;
    ...
    cartUpdateEvents() {if (!checkLicenseValidity()) return;
      this.items = document.querySelectorAll(selectors$5.item);

      this.items.forEach((item) => {if (!checkLicenseValidity()) return;
        item.addEventListener('theme:cart:update', (event) => {if (!checkLicenseValidity()) return;
          this.updateCart(
            {
              id: event.detail.id,
    ...
    cartRemoveEvents() {if (!checkLicenseValidity()) return;
      const cartItemRemove = document.querySelectorAll(selectors$5.cartItemRemove);

      cartItemRemove.forEach((button) => {if (!checkLicenseValidity()) return;
        const item = button.closest(selectors$5.item);
        button.addEventListener('click', (event) => {if (!checkLicenseValidity()) return;
          event.preventDefault();
      ...
      if (this.cartCloseErrorMessage) {
        this.cartCloseErrorMessage.addEventListener('click', (event) => {if (!checkLicenseValidity()) return;
          event.preventDefault();
    ...
    cartAddEvent(event) {if (!checkLicenseValidity()) return;
      let formData = '';
      ...
      const hasInputsInNoScript = [...form.elements].some((el) => {if (!checkLicenseValidity()) return;return el.closest(selectors$5.noscript);});
     ...
     */
    handleFormDataDuplicates(elements, formData) {if (!checkLicenseValidity()) return;
      if (!elements.length || typeof formData !== 'object') return formData;

      elements.forEach((element) => {if (!checkLicenseValidity()) return;
    ...
    cartEvents() {if (!checkLicenseValidity()) return;
    ...
    formSubmitHandler() {if (!checkLicenseValidity()) return;
    ...
    formErrorsEvents(errorContainer) {if (!checkLicenseValidity()) return;
      const buttonErrorClose = errorContainer.querySelector(selectors$5.formCloseError);
      buttonErrorClose?.addEventListener('click', (e) => {if (!checkLicenseValidity()) return;
        e.preventDefault();
    ...
    getCart() {if (!checkLicenseValidity()) return;
      fetch(theme.routes.cart_url + '?section_id=api-cart-items').
      then(this.cartErrorsHandler).
      then((response) => {if (!checkLicenseValidity()) return;return response.text();}).
      then((response) => {if (!checkLicenseValidity()) return;
      ...
      catch((error) => {if (!checkLicenseValidity()) return;return console.log(error);});
    }
    ...
    addToCart(formData, button) {if (!checkLicenseValidity()) return;
      if (this.cart) {
      ...
      then((response) => {if (!checkLicenseValidity()) return;return response.json();}).
      then((response) => {if (!checkLicenseValidity()) return;
        if (response.status) {
    ...
    updateCart(updateData = {}, currentItem = null) {if (!checkLicenseValidity()) return;
      this.cart.classList.add(classes$3.loading);
      ...
      then((state) => {if (!checkLicenseValidity()) return;
     ...
     * @return  {Void}
     */
    resetLineItem(item) {if (!checkLicenseValidity()) return;
    ...
    disableCartButtons() {if (!checkLicenseValidity()) return;
      ...
      if (buttons.length) {
        buttons.forEach((item) => {if (!checkLicenseValidity()) return;
     ...
     * @return  {Void}
     */
    enableCartButtons() {if (!checkLicenseValidity()) return;
      const inputs = this.cart.querySelectorAll('input');
      const buttons = this.cart.querySelectorAll(`button, ${selectors$5.cartItemRemove}`);
    ...
    updateErrorText(itemTitle) {if (!checkLicenseValidity()) return;
    ...
    toggleErrorMessage() {if (!checkLicenseValidity()) return;
    ...
    cartErrorsHandler(response) {if (!checkLicenseValidity()) return;
      if (!response.ok) {
        return response.json().then(function (json) {if (!checkLicenseValidity()) return;
    ...
    addToCartError(data, button) {if (!checkLicenseValidity()) return;
      if (button !== null) {
     ...
     * @return  {Void}
     */
    productAddCallback(event) {if (!checkLicenseValidity()) return;
      let buttons = [];
      ...
      buttons.forEach((button) => {if (!checkLicenseValidity()) return;
        button.classList.remove(classes$3.loading);
        if (!hasError) {
          button.classList.add(classes$3.added);
        }
    ...
    toggleClassesOnContainers() {if (!checkLicenseValidity()) return;
    ...
    build(data) {if (!checkLicenseValidity()) return;
      ...
      if (!this.hasItemsInCart()) {
        this.cartEmpty.querySelectorAll(selectors$5.animation).forEach((item) => {if (!checkLicenseValidity()) return;
    ...
    getCartItemCount() {if (!checkLicenseValidity()) return;
      return Array.from(this.cart.querySelectorAll(selectors$5.qtyInput)).reduce((total, quantityInput) => {if (!checkLicenseValidity()) return;return total + parseInt(quantityInput.value);}, 0);
    }
    ...
    hasItemsInCart() {if (!checkLicenseValidity()) return;
    ...
    freeShippingMessageHandle(total) {if (!checkLicenseValidity()) return;
      if (!this.freeShipping.length) return;

      this.freeShipping.forEach((message) => {if (!checkLicenseValidity()) return;
    ...
    updateProgress() {if (!checkLicenseValidity()) return;
      this.freeShipping = document.querySelectorAll(selectors$5.freeShipping);
      ...
      this.freeShipping.forEach((item) => {if (!checkLicenseValidity()) return;
     ...
     * Skip upsell product
     */
    skipUpsellProductEvent() {if (!checkLicenseValidity()) return;
      ...
      if (skipButtons.length) {
        skipButtons.forEach((button) => {if (!checkLicenseValidity()) return;
          button.addEventListener('click', (event) => {if (!checkLicenseValidity()) return;
            event.preventDefault();
     ...
     */
    checkSkippedUpsellProductsFromStorage() {if (!checkLicenseValidity()) return;
      ...
      skippedUpsellItemsFromStorageArray.forEach((productID) => {if (!checkLicenseValidity()) return;
        if (!this.skipUpsellProductsArray.includes(productID)) {
          this.skipUpsellProductsArray.push(productID);
        }
    ...
    removeUpsellProduct(productID) {if (!checkLicenseValidity()) return;
     ...
     */
    toggleCartUpsellWidgetVisibility() {if (!checkLicenseValidity()) return;
      if (!this.upsellProductsHolder) return;
     ...
     * @return  {Void}
     */
    resetAnimatedItems() {if (!checkLicenseValidity()) return;
      this.cart.querySelectorAll(selectors$5.animation).forEach((item) => {if (!checkLicenseValidity()) return;
        item.classList.remove(classes$3.animated);
        item.classList.remove(classes$3.hiding);
      });
     ...
     * @return  {Void}
     */
    animateItems(e) {if (!checkLicenseValidity()) return;
      requestAnimationFrame(() => {if (!checkLicenseValidity()) return;
        let cart = this.cart;
        ...
        cart?.querySelectorAll(selectors$5.animation).forEach((item) => {if (!checkLicenseValidity()) return;
          item.classList.add(classes$3.animated);
        });
      });
    }

    recentlyViewedProducts() {if (!checkLicenseValidity()) return;
  ...
  class CartCount extends HTMLElement {
    ...
    onCartChange(event) {if (!checkLicenseValidity()) return;
  ...
  class CartDrawer extends HTMLElement {
     ...
     * @return  {Void}
     */
    openCartDrawerOnProductAdded() {if (!checkLicenseValidity()) return;
     ...
     * @return  {Void}
     */
    openCartDrawerOnSelect(e) {if (!checkLicenseValidity()) return;
     ...
     * @return  {Void}
     */
    closeCartDrawerOnDeselect() {if (!checkLicenseValidity()) return;
      if (this.cartDrawerIsOpen) {
    ...
    openCartDrawer(forceOpen = false) {if (!checkLicenseValidity()) return;
      ...
      waitForAnimationEnd(this.cartDrawerInner).then(() => {if (!checkLicenseValidity()) return;
        trapFocus(this, {
    ...
    closeCartDrawer() {if (!checkLicenseValidity()) return;
    ...
    toggleCartDrawer() {if (!checkLicenseValidity()) return;
      if (!this.cartDrawerIsOpen) {
        this.openCartDrawer();
      } else {
        this.closeCartDrawer();
    ...
    closeCartEvents() {if (!checkLicenseValidity()) return;
      this.cartDrawerClose.addEventListener('click', (e) => {if (!checkLicenseValidity()) return;
        e.preventDefault();
        this.closeCartDrawer();
      });

      this.addEventListener('keyup', (e) => {if (!checkLicenseValidity()) return;
        if (e.code === 'Escape') {
          this.closeCartDrawer();
        }
      });
  ...
  class CollapsibleElements extends HTMLElement {
    ...
    connectedCallback() {if (!checkLicenseValidity()) return;
      ...
      this.collapsibles.forEach((collapsible) => {if (!checkLicenseValidity()) return;
        const trigger = collapsible.querySelector(selectors$3.trigger);
        const body = collapsible.querySelector(selectors$3.body);

        trigger?.addEventListener('click', (event) => {if (!checkLicenseValidity()) return;return this.onCollapsibleClick(event);});

        body?.addEventListener('transitionend', (event) => {if (!checkLicenseValidity()) return;
    ...
    toggle() {if (!checkLicenseValidity()) return;
    ...
    open(collapsible) {if (!checkLicenseValidity()) return;
    ...
    close(collapsible) {if (!checkLicenseValidity()) return;
    ...
    setBodyHeight(body, contentHeight) {if (!checkLicenseValidity()) return;
      body.style.height = contentHeight !== 'auto' && contentHeight !== '' ? `${contentHeight}px` : contentHeight;
    }

    onCollapsibleClick(event) {if (!checkLicenseValidity()) return;
      event.preventDefault();
      ...
      if (this.single) {
        this.collapsibles.forEach((otherCollapsible) => {if (!checkLicenseValidity()) return;
  ...
  class SearchPopdown extends HTMLElement {
    ...
    connectedCallback() {if (!checkLicenseValidity()) return;
      ...
      this.popdownContainer.addEventListener('keyup', (event) => {if (!checkLicenseValidity()) return;return event.code.toUpperCase() === 'ESCAPE' && this.close();});
    ...
    detailsToggleCallback(event) {if (!checkLicenseValidity()) return;
      if (event.target.hasAttribute('open')) {
        this.open();
      }
    }

    popdownTransitionCallback(event) {if (!checkLicenseValidity()) return;
    ...
    onBodyClick(event) {if (!checkLicenseValidity()) return;
    ...
    close() {if (!checkLicenseValidity()) return;
  ...
  class MainSearch extends HeaderSearchForm {
    ...
    setupEventListeners() {if (!checkLicenseValidity()) return;
      let allSearchForms = [];
      this.allSearchInputs.forEach((input) => {if (!checkLicenseValidity()) return;return allSearchForms.push(input.form);});
      this.input.addEventListener('focus', this.onInputFocus.bind(this));
      if (allSearchForms.length < 2) return;
      allSearchForms.forEach((form) => {if (!checkLicenseValidity()) return;return form.addEventListener('reset', this.onFormReset.bind(this));});
      this.allSearchInputs.forEach((input) => {if (!checkLicenseValidity()) return;return input.addEventListener('input', this.onInput.bind(this));});
    }
    ...
    onInput(event) {if (!checkLicenseValidity()) return;
      const target = event.target;
      this.keepInSync(target.value, target);
    }

    onInputFocus() {if (!checkLicenseValidity()) return;
      if (!isDesktop()) {
        this.scrollIntoView({ behavior: 'smooth' });
      }
    }

    keepInSync(value, target) {if (!checkLicenseValidity()) return;
      this.allSearchInputs.forEach((input) => {if (!checkLicenseValidity()) return;
        if (input !== target) {
          input.value = value;
        }
      });
  ...
  class ToggleEllipsis extends HTMLElement {
    ...
    setHeight(contentHeight) {if (!checkLicenseValidity()) return;
      this.style.setProperty('--height', `${contentHeight}px`);
    }

    toggleActions() {if (!checkLicenseValidity()) return;
